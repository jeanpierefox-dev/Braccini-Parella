...
export const App: React.FC = () => {
  ...
  const rotateTeam = (players: Player[]) => {
    // CORRECT ROTATION: Clockwise.
    // Standard Array: [P1, P2, P3, P4, P5, P6]
    // Rotate: P2 moves to P1. P1 moves to P6.
    // New Array: [P2, P3, P4, P5, P6, P1]
    // Operation: Shift first element (P1), Push it to end.
                ...
                <div className="space-y-4 pb-20">
                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        ...
                        <div className={`${currentUser.role === 'REFEREE' ? 'lg:col-span-12' : 'lg:col-span-6'} flex flex-col gap-4`}>
                            ...
                            {/* Courts */}
                            <div className={`flex flex-col gap-4 ${currentUser.role === 'REFEREE' ? 'md:flex-row' : ''}`}>
                                ...
                                {currentUser.role !== 'REFEREE' && <div className="h-1 bg-white/20 w-full rounded-full"></div>}
