...
export const TVOverlay: React.FC<TVOverlayProps> = ({ 
  ...
  // Only trigger transition if the BOOLEAN flags change, NOT when score changes
  useEffect(() => {
    // Only run if the props effectively changed visibility state
  ...
  }, [showScoreboard, showStatsOverlay]); // Remove visibleScoreboard dependencies to avoid loops
